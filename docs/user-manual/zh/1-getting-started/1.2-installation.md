...
请只从本仓库的 **[GitHub Releases](https://github.com/HoshiTakyobu/cc-switch-self-use/releases)** 或源码获取 CC Switch。这个仓库是个人自用二开版本，不提供其他官方网站或付费服务。
...
1. 访问 [Releases 页面](https://github.com/HoshiTakyobu/cc-switch-self-use/releases)
