...
この個人用フォークは **[GitHub Releases](https://github.com/HoshiTakyobu/cc-switch-self-use/releases)** またはソースツリーからのみ入手してください。別の公式サイトや有料サービスは提供していません。
...
1. [Releases ページ](https://github.com/HoshiTakyobu/cc-switch-self-use/releases) にアクセス
