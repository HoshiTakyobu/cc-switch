...
Only download this personal fork from its **[GitHub Releases](https://github.com/HoshiTakyobu/cc-switch-self-use/releases)** or source tree. This repository does not provide a separate website or paid service.
...
1. Visit the [Releases page](https://github.com/HoshiTakyobu/cc-switch-self-use/releases)
