...
This fork currently maintains Windows release packages. Download the appropriate version from the [Releases page](https://github.com/HoshiTakyobu/cc-switch-self-use/releases).
...
1. Visit [GitHub Issues](https://github.com/HoshiTakyobu/cc-switch-self-use/issues)
